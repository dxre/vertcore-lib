...
var HDPrivateKey = vertcore.HDPrivateKey;
var HDPublicKey = vertcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = vertcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(vertcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(vertcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      vertcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = vertcore.PublicKey.fromPoint;
      vertcore.PublicKey.fromPoint = function() {
        vertcore.PublicKey.fromPoint = unstubbed;
