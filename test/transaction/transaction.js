...
var Input = vertcore.Transaction.Input;
var Output = vertcore.Transaction.Output;
var PrivateKey = vertcore.PrivateKey;
var Script = vertcore.Script;
var Address = vertcore.Address;
var Networks = vertcore.Networks;
var Opcode = vertcore.Opcode;
var errors = vertcore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(vertcore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(vertcore.Script);
